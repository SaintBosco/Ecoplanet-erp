...
// Restrict cross-origin access to an explicit allowlist (env-driven) instead
// of '*'. Defaults to localhost for local/dev use; set ALLOWED_ORIGINS in
// production (comma-separated) once the real domain is known.
